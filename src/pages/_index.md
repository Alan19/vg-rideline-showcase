...
These prices are based on [TCGCSV](https://tcgcsv.com/) and are updated around once per day around 5PM Eastern Time. The prices are based on the lowest price (excluding shipping). Keep in mind that TCGPlayer charges a ~15% fee as well as shipping, and you can often save money by asking around your LGS or local groups instead.
...
- Offense generally refers to the ability of a deck to deal damage to your opponent and how fast can the deck remove cards from your opponent. 
- Control generally refers to a deck's ability to slow down the other deck's gameplan and prevent them from achieving their ideal boardstate. 
- Value generally refers to a deck's ability to gain card advantage, improve the quality of their drive checks, or the amount of shield in hand. 
